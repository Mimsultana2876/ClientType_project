                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/admin/show_project_type')}}"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/admin/show_client_details')}}"
                                aria-expanded="false">
...
$(document).ready(function () {
  ...
  <script src="{{asset('assets/project_type.js')}}"></script>
  <script src="{{asset('assets/client_details.js')}}"></script>
